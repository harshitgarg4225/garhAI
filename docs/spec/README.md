...
| `02-product-spec.md` | The CPTO-reviewed product spec: features F0–F10, acceptance criteria, MVP vs v1.1/v2/v3 waves, launch metrics, legal and data policy | When you need feature *intent*, an acceptance criterion, or an MVP cut line. |
