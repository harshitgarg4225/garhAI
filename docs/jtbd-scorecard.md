...
| J04 Generate compliant plan options   |     8 | Options carry their seed and a plain-prose rationale, the zero-options screen shows the worker's diagnosis, and parking is measured off the plan, placed by the solver and drawn on A-01 — one catalogue entry for all three. The §14 time budget and determinism profile run against real CP-SAT. Open: coverage is 37/60 against the packs' real setbacks, the solver gate ignores accepted overrides, and nothing clicks Generate in a browser.                                                                                                                                                                                                                                                                                          |
