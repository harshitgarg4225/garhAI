...
const STROKE_PATHS = {
  ...
  sheet:
    'M6 3 L14 3 L18.5 7.5 L18.5 21 L6 21 Z M14 3 L14 7.5 L18.5 7.5 M9 12.5 L15.5 12.5 M9 16.5 L15.5 16.5',
  ...
  'log-out':
    'M15 7.5 L15 4.5 L4.5 4.5 L4.5 19.5 L15 19.5 L15 16.5 M9.5 12 L20 12 M16.5 8.5 L20 12 L16.5 15.5',
  ...
  'external-link':
    'M14 4.5 L19.5 4.5 L19.5 10 M19.5 4.5 L11.5 12.5 M17 14 L17 19.5 L4.5 19.5 L4.5 7 L10 7',
  ...
  message:
    'M12 4 C6.8 4 3 7.5 3 11.8 C3 14 4 15.9 5.7 17.3 L4.8 20.6 L8.6 19 C9.6 19.4 10.8 19.6 12 19.6 C17.2 19.6 21 16.1 21 11.8 C21 7.5 17.2 4 12 4 Z',
  lightbulb:
    'M9.3 18 L14.7 18 M10.3 21 L13.7 21 M12 3 A6 6 0 0 0 9.1 14.3 L9.3 18 M12 3 A6 6 0 0 1 14.9 14.3 L14.7 18',
  user: 'M12 4 A3.8 3.8 0 1 0 12 11.6 A3.8 3.8 0 0 0 12 4 Z M4.5 20.5 C4.5 16.6 7.9 14 12 14 C16.1 14 19.5 16.6 19.5 20.5',
  users:
    'M9.5 4.5 A3.5 3.5 0 1 0 9.5 11.5 A3.5 3.5 0 0 0 9.5 4.5 Z M2.5 20 C2.5 16.4 5.6 14 9.5 14 C13.4 14 16.5 16.4 16.5 20 M16.2 5.2 A3.4 3.4 0 0 1 16.2 11.3 M18 14.4 C20.2 15.2 21.5 17.2 21.5 20',
  'more-horizontal': 'M6 12 L6.01 12 M12 12 L12.01 12 M18 12 L18.01 12',
  loader:
    'M12 3.5 L12 7 M12 17 L12 20.5 M3.5 12 L7 12 M17 12 L20.5 12 M6 6 L8.5 8.5 M15.5 15.5 L18 18 M18 6 L15.5 8.5 M8.5 15.5 L6 18',
